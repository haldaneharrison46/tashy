...
<div class="section">
  <div class="container" style="max-width:860px">
    ...
    <div style="text-align:center;padding:60px 0">
      ...
      <a href="<?= asset_base() ?>/shop.php" class="btn btn-primary" style="margin-top:20px">Continue Shopping</a>
    </div>
    <?php else: ?>
    <div style="display:grid;grid-template-columns:1fr 320px;gap:32px;align-items:start">
      ...
      <div>
        <table class="cart-table" style="width:100%;border-collapse:collapse">
          ...
          <tr style="border-bottom:1px solid var(--grey-light)">
            <td style="padding:16px 0;display:flex;gap:14px;align-items:center">
              ...
              <div>
                <a href="<?= asset_base() ?>/product.php?slug=<?= h($item['slug']) ?>" style="font-weight:600"><?= h($item['name']) ?></a>
        ...
        <div style="margin-top:16px">
          <a href="<?= asset_base() ?>/shop.php" class="btn btn-outline btn-sm">← Continue Shopping</a>
        </div>
      </div>
      ...
      <div class="cart-summary" style="background:var(--white);border:1px solid var(--grey-light);border-radius:12px;padding:24px">
        ...
        <a href="<?= asset_base() ?>/checkout.php" class="btn btn-primary" style="width:100%;margin-top:20px;text-align:center">Checkout →</a>
      </div>
    </div>
    <?php endif; ?>
  </div>
