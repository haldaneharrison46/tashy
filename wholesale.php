...
$metaDesc  = sk('Partner with Tashy Kollections — wholesale home décor, bedding & fragrances for hotels, resorts, villas, gift shops, and resellers across Jamaica. Trade pricing, reliable supply.',
                ...
                'Partner with ' . SITE_NAME . ' — wholesale handbags, fashion, footwear & beauty for boutiques and resellers across the US and Jamaica. Trade pricing, reliable supply.');
...
<section class="wholesale-hero">
  <div class="container">
    ...
    <p><?= sk('Quality home décor, bedding &amp; fragrances at trade pricing — for hotels, resorts, villas, gift shops, and resellers across Jamaica.', 'Quality beauty supplies — hair, skin, makeup &amp; tools at trade pricing — for salons, spas, barbers, and resellers across Jamaica.', 'Quality handbags, fashion, footwear &amp; beauty at trade pricing — for boutiques and resellers across the US and Jamaica.') ?></p>
    <div class="stat-row">
            ...
            <select name="type" class="form-control">
              <?php
                $types = sk('Hotel / Resort,Villa / Airbnb Host,Gift Shop,Home Décor Retailer,Online Reseller,Other',
                            ...
                            'Boutique,Fashion Retailer,Beauty Retailer,Online Reseller,Pop-up / Market,Other');
                $types = explode(',', $types);
                $sel = $_POST['type'] ?? '';
                foreach ($types as $t):
              ?>
