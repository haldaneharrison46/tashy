-- ============================================================
-- Tashy Kollections — Home Decor catalog migration
-- Replaces the original (beauty) catalog with home decor products.
-- Run this ONCE against the live database (e.g. via phpMyAdmin —
-- select your database first, then run; no USE statement so it works
-- on any DB name).
--
...
(11, 3, 'Braided Cotton Doormat', 'braided-cotton-doormat',
  ...
  2400.00, 3000.00, 50, 'MAT-DOR-BRD', 'rug-2.jpg', 'doormat,cotton,braided,entry,mat', 0),
(12, 3, 'Boho Runner Rug (2.5x8 ft)', 'boho-runner-rug-25x8',
  ...
  9500.00, NULL, 22, 'RUG-RUN-258', 'rug-1.jpg', 'runner,rug,boho,hallway,mats', 0),
...
(15, 4, 'Noir Eau de Parfum — for Him', 'noir-eau-de-parfum-for-him',
  ...
  16500.00, NULL, 18, 'FRG-EDP-NOIR', 'pexels-karola-g-4735904.jpg', 'perfume,edp,men,woody,fragrance', 1),
(16, 4, 'Fleur Eau de Parfum — for Her', 'fleur-eau-de-parfum-for-her',
  ...
  16500.00, NULL, 18, 'FRG-EDP-FLEUR', 'pexels-karola-g-4735904.jpg', 'perfume,edp,women,floral,fragrance', 0),
